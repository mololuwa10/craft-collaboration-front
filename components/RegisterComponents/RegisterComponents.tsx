...
export default function RegisterComponents() {
	...
	const validateForm = () => {
		...
		Object.entries(fieldsToValidate).forEach(([fieldName, field]) => {
			const { value, message } = field as {
				value: string;
				message: string;
				additionalCheck?: () => boolean;
			};
			const additionalCheck =
				"additionalCheck" in field ? field.additionalCheck : undefined;
						...
						<div className="max-w-xl lg:max-w-3xl">
							<a className="block text-blue-600" href="/">
								...
								<img
									alt="Pattern"
									src="/CraftLogo.jpeg"
									className="h-20 sm:h-40 mr-[-47px]"
								/>
								{/* <svg
							...
							<p className="mt-4 leading-relaxed text-gray-500">
								The Home of all Artisanal Trade
							</p>
									...
									>
										...
										<div className="relative mt-2">
											...
											<button
												...
												className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-indigo-500"
											>
												{passwordShown ? (
